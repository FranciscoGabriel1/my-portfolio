...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        display: ["clamp(2.5rem, 5vw + 1rem, 4.5rem)", { lineHeight: "1.05", fontWeight: "900" }],
        h1: ["clamp(1.75rem, 3vw + 0.75rem, 3rem)", { lineHeight: "1.1", fontWeight: "800" }],
        h2: ["clamp(1.375rem, 2vw + 0.625rem, 2rem)", { lineHeight: "1.2", fontWeight: "700" }],
        h3: ["clamp(1.125rem, 1.5vw + 0.5rem, 1.5rem)", { lineHeight: "1.3", fontWeight: "600" }],
